  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Si APU<sup></sup></div>
      </a>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
      <a class="nav-link collapsed" href="/pelakuusaha/{{Auth::user()->id}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('/penghasilan')}}">
          <i class="fas fa-fw fa-folder"></i>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              {{-- <img class="img-profile rounded-circle" src="{{ Voyager::image(Auth::user()->avatar) }}"> --}}
              ...
              <a class="dropdown-item" href="{{url('/settingprofil')}}">
